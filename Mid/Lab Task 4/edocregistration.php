<?php require_once dirname(__FILE__) . "/controller/edocregistrationcontroller.php" ?>

<?php header_page("Edoc Registration"); ?>
    ...
    <section class="main">
        ...
        <main class="main__content main__content--registration">
            ...
            <form class="main__content--registration__form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <fieldset>
                    <legend>E. DOCTOR REGISTRATION</legend>
                    <div>
                        <table>
                            <tr>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>:<input type="text" name="degree" id="degree" value="<?php echo $Degree; ?>"></td>
                                <td class="error"><?php echo $err_degree; ?></td>
                            </tr>
                        </table>
                        <hr>
                        <table>
